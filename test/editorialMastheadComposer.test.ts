...
describe('editorial restyle: masthead & composer (#208)', () => {
	...
	describe('AC-10: Spec documentation', () => {
		it('chat-view.md contains current Masthead and Composer & State line specifications', () => {
			expect(specContent).toContain('### Masthead');
			expect(specContent).toContain('### Composer & State line');
			expect(specContent).toContain('directory/scope/attachment controls followed by the active note or selection');
